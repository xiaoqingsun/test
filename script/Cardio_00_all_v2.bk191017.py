...
def get_sampleInf(sampleid,cfgFile,feature_file):
    sample_inf_list=[]
    cover_Dic = defaultdict(list)
    head=['id','name','sex','age','date','chenghu','feature']
        ...
        with open(cfgFile, 'rU') as file_handle:
            for line in file_handle:
                ...
                if line_list[0]==sampleid:
                    ...
                    sample_inf_list=[line_list[0],line_list[4],line_list[5],age,date,chenghu,feature]  #需要送样日期，暂时用出报告日期代替
                    break
...
def get_insert_module(module,sampleid,gxy,cs):
    CS_Dic={}
    insert=''
    insert2=''
...
def main():
    ...
    insert_Dic = get_insert_module(module,sampleid,gxy_yinyang,cs_yinyang)
    ...
    with open('/PUBLIC/pipline/script/Report/XKFW/V3_180824/tempt/Cardio_all_temple.bk191017.tex','r') as file_handle:
