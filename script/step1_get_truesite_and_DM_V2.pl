...
use lib '/PUBLIC/work/sunxiaoqing/anno_updata/s1.Production_filtration/00.bin/';
use StandardClass;
...
sub read_database_2{ ################### sunxq 20180408
	my $shuju="/PUBLIC/work/sunxiaoqing/anno_updata/s1.Production_filtration/01.database/XK_DMbase_zhfu.right.txt";
	open IN, "<:utf8", "$shuju" || die "can't open the file";
	my %hash;
	my $key;
	my $aa=<IN>;
