...
while(<IN>)
{
	...
	$part10_2.=qq[ $cnv_loc & $cnv_copy & $cut[14] & \\makecell[{}{m{48mm}}]{$gene_cnv_dis} \\\\ \\hline \n];
}
close IN;
...
\begin{longtable}{| C{47mm} | C{16mm} | C{22mm} | m{49mm} | }
\hline
...
{
	$all_tex=$yemei.$biaoti2.$info_sample.$part1.$part9.$part10.$part7.$part1_list.$part6.$part8.$check."\n\\end{document} \n";
}
